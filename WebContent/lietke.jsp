...
<body>
	...
	<!-- TAT CA CAC property doi day phai duoc khai bao trong form class LietKeSinhVienForm  -->

		<html:form action="/liet-ke-action" method="post"
		...
		<div class="table-responsive">
			<table class="table table-bordered table-hover table-striped"
				...
				<tbody>
					...
					<!-- Chay vong lop voi arraylist sinhViens
					...
					soCMND cua item itme la 1 dong của arraylist, cung tuong ung voi 1 dong trong csdl
					 -->
					<logic:iterate name="lietKeSinhVienForm" property="sinhViens"
						id="item">
						<tr class="odd gradeX" align="center">
							...
							<td class="maTaiSan"><bean:write name="item"
									property="email" /></td>
							<td class="maTaiSan"><bean:write name="item" property="soDT" /></td>
							<td class="maTaiSan"><bean:write name="item"
									property="diaChi" /></td>
						</tr>
					</logic:iterate>
